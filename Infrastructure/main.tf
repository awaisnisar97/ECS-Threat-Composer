...
module "ecs" {
  ...
  privatesubnet_ids         = [module.vpc.private_subnet1_id, module.vpc.private_subnet2_id]
...
module "alb" {
  ...
  publicsubnet_ids           = [module.vpc.public_subnet1_id, module.vpc.public_subnet2_id]
